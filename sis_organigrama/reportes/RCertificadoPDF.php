...
class RCertificadoPDF extends  ReportePDF{
    function Header() {
        $this->ln(35);
        $img_file = dirname(__FILE__).'/../media/direcciones_act.jpg';
        //$img_agua = dirname(__FILE__).'/../media/marcaAgua.jpg';

        $this->Image($img_file, 2, 10, 500, 500, '', '', '', false, 300, '', false, false, 0);
...
<tr>
<td >&nbsp;</td>
<td><p style="text-align: justify"> <FONT FACE="Century Gothic" style="font-size: 12pt;" >La suscrita Lic. '.$this->datos[0]['jefa_recursos'].' <b>Jefe del Departamento de Recursos Humanos</b> de la Empresa Pública Nacional Estratégica "Boliviana de Aviación - BoA", a solicitud '.$tipo.'</FONT></p>
</td>
<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
<td>&nbsp;</td>
<td><p style="text-align: justify"><FONT FACE="Century Gothic" style="font-size: 12pt;" >Que, de la revisión de la carpeta que cursa en el Departamento de Recursos. se evidencia que '.$gen.' <b>'.$this->datos[0]['genero'].'. '.$this->datos[0]['nombre_funcionario'].'</b> con C.I. '.$this->datos[0]['ci'].' '.$this->datos[0]['expedicion'].', ingresó a la Empresa Pública Nacional Estratégica "Boliviana de Aviación - BoA"
