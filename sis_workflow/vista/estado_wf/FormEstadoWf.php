...
Phx.vista.FormEstadoWf=Ext.extend(Phx.frmInterfaz,{
    ...
    successSinc:function(resp){
        ...
        } else if (reg.ROOT.datos.error_validacion_campos='si' && reg.ROOT.datos.firma_digital =='no'){   
            Ext.getCmp(this.config.idContenedor).close();
            Ext.Msg.show({
                        title: 'Información',
                        msg: `<b>Estimado usuario:</b><br>${reg.ROOT.datos.mensaje}`,
                        buttons: Ext.Msg.OK,
                        width: 512,
                        icon: Ext.Msg.INFO
                    });
