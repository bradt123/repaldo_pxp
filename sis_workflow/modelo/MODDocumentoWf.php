...
class MODDocumentoWf extends MODbase{
   ...
   function verificarConfiguracion(){
	...
	function insertDocumentFirmaDigiWf(){
        ...
        try {
            ...
            $this->aParam->addParametro('firma_digital', $firma_digital);
            $this->arreglo['firma_digital'] = $firma_digital;
            $this->setParametro('firma_digital', 'firma_digital', 'varchar');
            
            $this->setParametro('extension','extension','varchar');

            $this->aParam->addParametro('name_file', $name_pdf);
            $this->arreglo['name_file'] = $name_pdf;
            $this->setParametro('name_file', 'name_file', 'varchar');            
	                        
            $this->arreglo['file_name'] = './../../../uploaded_files/sis_workflow/DocumentoWf/'.$file_name[3];
            $this->setParametro('file_name','file_name','varchar');
            ...
            if($resp_procedimiento['tipo_respuesta'] == 'EXITO'){
               ...
               if($respuesta['max_version'] != '0' && $respuesta['url_destino'] != ''){
                ...
                $this->copyFile($ruta1, './../../../uploaded_files/sis_workflow/DocumentoWf/'.$file_name[3]);
             }
