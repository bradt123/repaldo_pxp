...
//$data ="id=".$array['id_documento_wf']."&extension=".$array['extension']."&sistema=sis_workflow"."&clase=DocumentoWf"."&url=".$array['url'];
...
?>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="./../../lib/ux/visor_pdf/img/icon.jpg" type="image/x-icon">
        <link rel="stylesheet" type="text/css" href="./css/style_pdf_img.css">
    ...
    <body>
    <div class="wrapper">
        <div class="ui card" style="top:10px;left:10px;width:200px;">
            <img class="ui rounded image" src="./../../lib/ux/visor_pdf/img/title.jpg">
        </div>
    ...
    echo '<script>'
      .'let pdf = "'.$base64.'";'
      .'</script>'
      .'<script src="./js/pdf_to_img.js"></script>';
     ?>        
    </body>
    </html>;
