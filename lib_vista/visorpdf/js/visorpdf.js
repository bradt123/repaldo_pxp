...
function miFuncion() {                   
    ...
    if (bol) {
        ...
        if (data_sign[0] != undefined) {
            data_sign.forEach(item => {
                html += `
        <div class="ui vertical accordion menu" style="width:280px;font-size:12px;">
        <div class="item">
            <a class="title">
    ...
    document.getElementById('name_doc').innerHTML = `<span>Documento: </span>${name_doc}`;
